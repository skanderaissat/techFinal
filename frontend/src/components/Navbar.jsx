  ...
  return (
    <div>
    {
     ...
     <Container>
      <Wrapper>
        <Left>
         <Link to="/home" style={{textDecoration:"none",color:"black"}}> <Logo>TECHNOLOGY</Logo></Link>
 ...
 <Dropdown.Item  onClick={()=>{dispatch(filterProduct('All'));navigate('/productlist')}}>All Products</Dropdown.Item>
  ...
  <Dropdown.Item onClick={()=>dispatch(filterProduct('GAMING'))} >Gaming</Dropdown.Item>
    ...
    <Container>
      <Wrapper>
        <Left>
         <Link to="/home" style={{textDecoration:"none",color:"black"}}> <Logo>TEHNOLOGY</Logo></Link>
          <DropdownButton id="dropdown-basic-button" title="Categories">
 <Dropdown.Item onClick= {()=>{dispatch(filterProduct('All'));navigate('/productlist')}}>All Products</Dropdown.Item>
